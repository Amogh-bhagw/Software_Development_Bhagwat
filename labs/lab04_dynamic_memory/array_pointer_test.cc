...
ArrayPointerTest::ArrayPointerTest(int count) {
  ...
  cout<< "Size of duck1 is:" <<  sizeof(Duck) << endl;
...
cout<< "Size of duck2 is:" << 8 * sizeof(Duck) << endl;
  ...
  cout<< "Size of duck1 is:" << sizeof(ducks3_) << endl;
  cout << "Initializing ducks4\n";
  // Write code here to create count_ ducks for array ducks4 (if required) question 10
